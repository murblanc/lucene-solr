...
public class CreateShardCmd implements CollectionHandlingUtils.Cmd {
  ...
  public void call(ClusterState clusterState, ZkNodeProps message, NamedList results) throws Exception {
    ...
    if (ccc.getDistributedClusterChangeUpdater().isDistributedStateChange()) {
      ...
      ccc.getDistributedClusterChangeUpdater().doSingleStateUpdate(DistributedClusterChangeUpdater.MutatingCommand.CollectionCreateShard, message,
