 ...
 */
abstract class AliasCmd implements CollectionHandlingUtils.Cmd {

  protected final CollectionCommandContext ccc;

  public AliasCmd(CollectionCommandContext ccc) {
    this.ccc = ccc;
  }
  ...
  static NamedList createCollectionAndWait(ClusterState clusterState, String aliasName, Map<String, String> aliasMetadata,
    ...
    CollectionsHandler.waitForActiveCollection(createCollName, ccc.getCoreContainer(),
