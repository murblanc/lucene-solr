...
public class DeleteCollectionCmd implements CollectionHandlingUtils.Cmd {
  ...
  public void call(ClusterState state, ZkNodeProps message, @SuppressWarnings({"rawtypes"})NamedList results) throws Exception {
    ...
    try {
      ...
      if (ccc.getDistributedClusterChangeUpdater().isDistributedStateChange()) {
        ccc.getDistributedClusterChangeUpdater().doSingleStateUpdate(DistributedClusterChangeUpdater.MutatingCommand.ClusterDeleteCollection, m,
